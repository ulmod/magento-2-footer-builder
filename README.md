# Magento 2 Footer Builder Extension

[Magento 2 Footer Builder](https://www.ulmod.com/footer-builder-for-magento-2.html)  is a Magento 2 extension that allows you to create a custom footer to met your business requirement.

With Magento 2 Footer Builder, you can create any footer type to gives your website the credibility that it belongs to a real business

<a href="https://www.ulmod.com/footer-builder-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Create any footer type, per your requirement
* Ability to show/hide newsletter block in footer
* Support one footer top
* Support two-footer middle row with 4 columns, 12 columns size
* Support one footer bottom to display copyright, logo image, and any other content
* Ability to include static block at any footer blocks (top, middle, and bottom)
* Support heading block
* Work any custom theme
* Mobile-friendly
* Support multiple-stores
* Ability to adjust footer colors per your needs


<img src="https://www.ulmod.com/media/ulmod/product_content/footerb-main1-min.png">
